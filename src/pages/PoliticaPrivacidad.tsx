  ...
  <div className="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <div className="prose prose-sm max-w-none space-y-6 text-foreground/90 leading-relaxed">
      <section>
        ...
        <p>El responsable del tratamiento de los datos personales recogidos en este sitio web es <strong>David [Apellido]</strong>, con domicilio en España. Para cualquier consulta relacionada con la privacidad, puede contactar en: <a href="mailto:contacto@probarber.es" className="text-primary hover:underline">contacto@probarber.es</a>.</p>
      </section>

      <section>
        <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">2. Datos que recopilamos</h2>
        <p>En ProBarber.es recopilamos los siguientes tipos de información:</p>
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li><strong>Cookies y tecnologías similares:</strong> tanto propias como de terceros (Google AdSense, Google Analytics). Consulte nuestra <Link to="/politica-cookies" className="text-primary hover:underline">Política de Cookies</Link> para más detalles.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>Google utiliza la cookie DART y otras tecnologías para personalizar los anuncios según las visitas previas del usuario a nuestro sitio y a otros sitios web. Puede obtener más información sobre cómo Google utiliza los datos en: <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://policies.google.com/technologies/ads</a>.</p>
      ...
      <section>
        ...
        <p>Puede optar por no recibir anuncios personalizados visitando la <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">configuración de anuncios de Google</a> o la página de exclusión voluntaria de la <a href="https://optout.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Network Advertising Initiative</a>.</p>
      ...
      <section>
        ...
        <p className="mt-2">Para ejercer estos derechos, contacte con nosotros en <a href="mailto:contacto@probarber.es" className="text-primary hover:underline">contacto@probarber.es</a>. También tiene derecho a presentar una reclamación ante la <strong>Agencia Española de Protección de Datos (AEPD)</strong>: <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">www.aepd.es</a>.</p>
      </section>

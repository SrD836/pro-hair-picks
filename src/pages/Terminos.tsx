  ...
  <div className="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <div className="prose prose-sm max-w-none space-y-6 text-foreground/90 leading-relaxed">
      <section>
        ...
        <p>El presente sitio web, <strong>GuiaDelSalon.es</strong>, es propiedad de David [Apellido], con domicilio en España. El acceso y uso de este sitio web implica la aceptación de los presentes Términos y Condiciones.</p>
      </section>
      ...
      <section>
        ...
        <p>GuiaDelSalon.es participa en el <strong>Programa de Afiliados de Amazon EU</strong> (Amazon Associates), un programa de publicidad diseñado para proporcionar un medio para que los sitios web ganen comisiones por publicidad mediante enlaces a Amazon.es.</p>
      ...
      <section>
        ...
        <p className="bg-accent p-4 rounded-lg border border-border"><strong>Importante:</strong> El contenido publicado en GuiaDelSalon.es tiene carácter meramente informativo y orientativo. No somos profesionales médicos, dermatólogos ni especialistas sanitarios. Nuestras recomendaciones se basan en análisis de características técnicas, opiniones de usuarios y pruebas de productos, pero no sustituyen el asesoramiento profesional.</p>
      ...
      <section>
        ...
        <p>Todo el contenido de este sitio web, incluyendo pero no limitado a textos, gráficos, logotipos, iconos, imágenes, compilaciones de datos y software, es propiedad de GuiaDelSalon.es o de sus respectivos propietarios y está protegido por las leyes de propiedad intelectual españolas e internacionales.</p>
      ...
      <section>
        ...
        <p>GuiaDelSalon.es no se responsabiliza de:</p>
        <ul className="list-disc pl-6 space-y-1">
      ...
      <section>
        ...
        <p>Para cualquier consulta sobre estos términos, puede contactar con nosotros en <a href="mailto:contacto@guiadelsalon.es" className="text-secondary hover:underline">contacto@guiadelsalon.es</a> o a través de nuestro <Link to="/contacto" className="text-secondary hover:underline">formulario de contacto</Link>.</p>
      </section>
    </div>
  </div>
);

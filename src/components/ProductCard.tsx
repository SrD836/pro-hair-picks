...
const ProductCard = ({ product, index }: ProductCardProps) => {
  const badge = classificationConfig[product.classification];
  ...
  return (
    ...
    >
      ...
      <div className="p-5 pt-6 flex flex-col sm:flex-row gap-5">
        {/* Image placeholder */}
        <div className="w-full sm:w-40 h-40 bg-muted rounded-lg flex items-center justify-center shrink-0">
